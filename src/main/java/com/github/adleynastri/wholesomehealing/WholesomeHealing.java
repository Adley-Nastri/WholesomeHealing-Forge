...
@Mod(MOD_ID)
public class WholesomeHealing {

    public static final String MOD_ID = "wholesomehealing";
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();

    @OnlyIn(Dist.CLIENT)
    public WholesomeHealing() {
        ...
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, ConfigFile.SPEC, "wholesomehealing-common.toml");

        // Register ourselves for server and other game events we are interested in
        MinecraftForge.EVENT_BUS.register(this);
        MinecraftForge.EVENT_BUS.addListener(EventPriority.HIGHEST, EventHandler::onPetInteract);
    }
    ...
    private void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        InterModComms.sendTo("wholesomehealing", "helloworld", () -> {
